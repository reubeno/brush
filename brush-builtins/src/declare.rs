...
crate::usage_minus_or_plus_flag_arg!(MakeExportedFlag, 'x', "+x", "Mark the variable for export.");
...
brush_builtin_usage::usage_builtin!(DeclareCommand, declarations = declarations);
