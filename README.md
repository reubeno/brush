...
<summary>🐧 <b>Installing on Fedora and Derivatives</b></summary>

Fedora Linux users must first install the [Terra repository]([https://archlinux.org/packages/extra/x86_64/brush/](https://terrapkg.com/)).
